...
void        NV_API_CALL  os_free_sema                (void *);
...
#define NV_FLUSH_USER_CACHE       1
#define NV_INVALIDATE_USER_CACHE  2
#define NV_FLUSH_INVALIDATE_USER_CACHE (NV_FLUSH_USER_CACHE | NV_INVALIDATE_USER_CACHE)
